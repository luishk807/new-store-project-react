...
import ProductBasic from 'src/components/inventarioz/product/ProductBasic'
import ProductAddVariants from 'src/components/inventarioz/product/ProductAddVariants'
import ProductVariants from 'src/components/inventarioz/product/ProductVariants'
import ProductStock from 'src/components/inventarioz/stock/ProductStock'
import { useRouter } from 'next/router'
import { useEffect, useState } from 'react'
import { getProduct } from 'src/services/inventarioz/product'
import { getStock } from 'src/services/inventarioz/stock'
import {
    Tab
